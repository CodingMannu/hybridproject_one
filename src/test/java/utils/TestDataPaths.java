...
public class TestDataPaths {
    ...
    public static final String BASE_PATH = System.getProperty("user.dir") + "/src/test/resources/testdata/";
    ...
    public static final String GLOBAL_PATH      = BASE_PATH + "ToastMessage.json";
