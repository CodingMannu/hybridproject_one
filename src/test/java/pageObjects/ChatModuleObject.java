...
public class ChatModuleObject extends TestBase {
...
//					throw new RuntimeException("Astrologer is offline. Cannot proceed with chat.");
	...
	public void getThankYouMessageAfterEndChat() {
		if (isElementVisible(thank_you_message_after_end_chat, 10)) {
			logger.info("Thank you message is visible after ending chat.");
			if (isElementVisible(click_ok_button_after_end_chat, 10)) {
				...
				throw new RuntimeException("Ok button after end chat is not visible.");
			}
		} else {
