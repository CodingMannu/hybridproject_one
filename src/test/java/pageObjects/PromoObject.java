...
import utils.TestDataPaths;
    ...
    public class PromoObject extends TestBase {
	...
	public void EntersPlaceOfBirth() {
		...
		executionDelay(2);
		EntersPlaceOfBirth.sendKeys(readDataFromJson(TestDataPaths.LOGIN_PATH, "Login", "birthDetails", "placeOfBirth"));
	}
	...
	public void user_enters_the_mobile_number() 
	{
		...
		user_enters_the_mobile_number.sendKeys(readDataFromJson(TestDataPaths.PROMO_PATH, "Promo", "repeatUser", "mobileNumber"));
		executionDelay(5);
	}
