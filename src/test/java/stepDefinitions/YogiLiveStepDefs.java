...
public class YogiLiveStepDefs {
	...
	YogiLiveObject yogiLiveObject;

	public YogiLiveStepDefs(TestContextSetup testContextSetup) {
		this.testContextSetup = testContextSetup;
		this.yogiLiveObject = testContextSetup.pageObjectManager.getYogiLiveObject();
	}
